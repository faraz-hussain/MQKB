...
let IPAD_AIR_PORTRAIT_BUTTON_Y_OFFSET: CGFloat = 105.0
let IPAD_AIR_PORTRAIT_BUTTON_X_GAP: CGFloat = 3.0
let IPAD_AIR_PORTRAIT_BUTTON_Y_GAP: CGFloat = 3.0

let IPAD_AIR_PORTRAIT_FORMULA_X_OFFSET: CGFloat = 90.0
let IPAD_AIR_PORTRAIT_FORMULA_Y_OFFSET: CGFloat = 0.0
let IPAD_AIR_PORTRAIT_FORMULA_WIDTH: CGFloat = 670.0
let IPAD_AIR_PORTRAIT_FORMULA_HEIGHT: CGFloat = 100.0
...
let IPAD_PRO10_PORTRAIT_BUTTON_Y_OFFSET: CGFloat = 135.0
let IPAD_PRO10_PORTRAIT_BUTTON_X_GAP: CGFloat = 3.0
let IPAD_PRO10_PORTRAIT_BUTTON_Y_GAP: CGFloat = 3.0

let IPAD_PRO10_PORTRAIT_FORMULA_X_OFFSET: CGFloat = 100.0
let IPAD_PRO10_PORTRAIT_FORMULA_Y_OFFSET: CGFloat = 0.0
let IPAD_PRO10_PORTRAIT_FORMULA_WIDTH: CGFloat = 730.0
let IPAD_PRO10_PORTRAIT_FORMULA_HEIGHT: CGFloat = 130.0
